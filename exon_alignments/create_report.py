"""
    ...
    From the latex file we develop a pdf file
    for conveniently study the scores

    (This was done prior to developing the gui, now with
    the availibility of the gui this is no longer required)
"""
